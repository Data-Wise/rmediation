...
### **Core Functions**
- `medci()` - Specialized for two-variable product (a*b indirect effects)
- `ci()` - General purpose for any nonlinear function
- `mbco()` - Model-Based Constrained Optimization tests

### **Distribution Functions**
- `pprodnormal()` / `qprodnormal()` - CDF and quantile for product of normals
...
### **Utility Functions**
- `tidy.logLik()` - S3 method for tidying logLik objects
...
1. Go to your GitHub repository: https://github.com/data-wise/rmediation
...
These will automatically appear in the "Articles" section of your website.
...
This will test your package on multiple platforms (Windows, macOS, Ubuntu) and R versions.
...
### Add Custom CSS/JS
Create `pkgdown/extra.css` or `pkgdown/extra.js` and reference in `_pkgdown.yml`.

### Customize Home Page
The homepage uses `README.md`. To add a custom homepage:
1. Create `index.md` in the root directory
2. pkgdown will use `index.md` instead of `README.md`
...
- Rebuild site with `pkgdown::build_site()`
...
**Website URL (after deployment):** https://data-wise.github.io/rmediation/
