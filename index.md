...
Below is the revised README.md file for the RMediation package,
incorporating additional features such as MBCO, parametric and
semi-parametric bootstrap methods, distribution of the product, and
...
1.  You have already performed a mediation analysis using a structural
    equation model (SEM) software and you have coeffiecient and indirect
...
2.  You have not yet performed a mediation analysis in `lavaan` or
    ...
    fitted model object– you do not need to specify the coefficnet
...
[GPL-3.0](https://choosealicense.com/licenses/gpl-3.0/). See the LICENSE
file for details.
