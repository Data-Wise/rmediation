...
#' @docType data
#' @keywords datasets
#' @note If you use the dataset, please cite the original article by MacKinnon et al. (2018) cited below.
#' @references MacKinnon, D. P., Valente, M. J., & Wurpts, I. C. (2018). Benchmark validation of statistical models: Application to mediation analysis of imagery and memory. Psychological Methods, 23, 654–671. \url{https://doi.org/10.1037/met0000174}
#' @source \url{http://dx.doi.org/10.1037/met0000174.supp}
"memory_exp"
