...
6. GitHub will display a message: "Your site is ready to be published at https://data-wise.github.io/rmediation/"
...
2. **Workflow builds site** → Runs `pkgdown::build_site_github_pages()`

3. **Deploys to `gh-pages`** → Uses JamesIves/github-pages-deploy-action

4. **GitHub Pages serves** → Website updates automatically

### Automatic Updates

Every time you push to `main`, the website will automatically rebuild and update. This includes:
...
- Errors in roxygen2 documentation
- Invalid `_pkgdown.yml` syntax

**Solution:**
- Fix the error in main branch
- Commit and push
...
**Wait time:**
- After workflow completes, allow 2-5 minutes for GitHub Pages to update
...
**Next Step:** Enable GitHub Pages in repository settings (see Step 1 above)

**Website URL:** https://data-wise.github.io/rmediation/

The setup is complete! Once you enable GitHub Pages in settings and push to main, your website will be live automatically. 🎉
